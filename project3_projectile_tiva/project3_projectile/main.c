...
int main(void)
{
    ...
    UARTConfig(SYSCTL_PERIPH_UART1, SYSCTL_PERIPH_GPIOC, GPIO_PC4_U1RX, GPIO_PIN_4, GPIO_PC5_U1TX, GPIO_PIN_5, GPIO_PORTC_BASE, UART1_BASE, 9600);
    ...
    while(1){
    	// read GPS data from UART1
     	//readGPS(UART1_BASE);
    	//mpu6050test(UART1_BASE, I2C1_BASE, MPU6050_ADDRESS);
